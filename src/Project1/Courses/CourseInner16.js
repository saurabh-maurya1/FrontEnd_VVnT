  ...
  return (
    ...
    <section id="course-inner">
      <div className="overview">
        <img className="course-img" src="https://media.istockphoto.com/id/1479421285/photo/engineer-working-on-laptop-with-virtual-screen-it-operations-high-software-quality-and.webp?b=1&s=612x612&w=0&k=20&c=tjMW5NJn0N3tkcfg7Vi3-kypvrZ-GW8xdHHcBIeK22s=" alt="" />
        <div className="course-head">
          <div className="c-name">
            <h2>Continous Testing with DevOps </h2>
            <div className="star">
        ...
        <br />
        <p>
          Elevate your skills to become a proficient Continous Testing with DevOps  expert with our specialized course: "Continous Testing with DevOps  In The Easiest Way". This comprehensive program is designed for professionals aiming to master the intricacies of optimizing software performance, ensuring applications run seamlessly under various conditions.
        </p>
        <br /><br />
        <h4>1. Continous Testing with DevOps </h4>
        <br />
        <p>
          Delve into the essential principles of Continous Testing with DevOps , gaining insights into strategies for evaluating and enhancing the speed, responsiveness, and scalability of software applications.
        </p>
        <br />
        <h4>2. Tools and Technologies</h4>
        <br />
        <p>
          Acquire proficiency in leading Continous Testing with DevOps tools and technologies, empowering you to conduct thorough assessments and identify areas for improvement in application performance.
        </p>
        <br />
        ...
        <div className="learn">
          <p><i className="far fa-check-circle"></i>Continous Testing with DevOps Strategies and Best Practices</p>
          <p><i className="far fa-check-circle"></i>Hands-on Experience with Leading Continous Testing with DevOps Tools</p>
