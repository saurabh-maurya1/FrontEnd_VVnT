  ...
  return (
    ...
    <section id="course-inner">
      <div className="overview">
        <img className="course-img" src="https://cdn.pixabay.com/photo/2018/05/16/18/16/cloud-3406627_1280.jpg" alt="" />
        <div className="course-head">
          <div className="c-name">
            <h2>Cloud Auditing and Assessments </h2>
            <div className="star">
        ...
        <br />
        <p>
          Elevate your skills to become a proficient Cloud Auditing and Assessments  expert with our specialized course: "Cloud Auditing and Assessments  In The Easiest Way". This comprehensive program is designed for professionals aiming to master the intricacies of optimizing software performance, ensuring applications run seamlessly under various conditions.
        </p>
        <br /><br />
        <h4>1. Cloud Auditing and Assessments Fundamentals</h4>
        <br />
        <p>
          Delve into the essential principles of Cloud Auditing and Assessments , gaining insights into strategies for evaluating and enhancing the speed, responsiveness, and scalability of software applications.
        </p>
        <br />
        <h4>2. Tools and Technologies</h4>
        <br />
        <p>
          Acquire proficiency in leading Cloud Auditing and Assessments tools and technologies, empowering you to conduct thorough assessments and identify areas for improvement in application performance.
        </p>
        <br />
        ...
        <div className="learn">
          <p><i className="far fa-check-circle"></i>Cloud Auditing and Assessments Strategies and Best Practices</p>
          <p><i className="far fa-check-circle"></i>Hands-on Experience with Leading Cloud Auditing and Assessments Tools</p>
