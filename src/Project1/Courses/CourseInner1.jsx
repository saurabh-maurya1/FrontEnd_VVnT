...
import img from '../courseimg/2.png'
    ...
    <div>
      ...
      <section id="course-inner">
        <div className="overview">
          <img className="course-img" src={img}  style={{objectFit:"contain"}} alt="" />
          <div className="course-head">
            <div className="c-name">
              <h2>Performance: Testing and Engineering</h2>
              <div className="star">
          ...
          <br />
          <p>
            Elevate your skills to become a proficient Performance Testing and Engineering expert with our specialized course: "Performance Testing and Engineering In The Easiest Way". This comprehensive program is designed for professionals aiming to master the intricacies of optimizing software performance, ensuring applications run seamlessly under various conditions.
          </p>
          <br /><br />
          <h4>1. Performance Testing Fundamentals</h4>
          <br />
          <p>
            Delve into the essential principles of performance testing and engineering, gaining insights into strategies for evaluating and enhancing the speed, responsiveness, and scalability of software applications.
          </p>
          <br />
          <h4>2. Tools and Technologies</h4>
          <br />
          <p>
            Acquire proficiency in leading performance testing tools and technologies, empowering you to conduct thorough assessments and identify areas for improvement in application performance.
          </p>
          <br />
          ...
          <div className="learn">
            ...
            <p><i className="far fa-check-circle"></i>Hands-on Experience with Leading Performance Testing Tools</p>
        ...
        <div className="enroll">
          ...
          <Button className="blue" href="#" onClick={(event)=>{enrollCourse()}}> Enroll Course</Button>
