...
import ig from '../courseimg/7.png'
  ...
  return (
    ...
    <section id="course-inner">
      <div className="overview">
        ...
        <br />
        <p>
          Elevate your skills to become a Everything in DevOps expert with our specialized course: Everything in DevOps In The Easiest Way". This comprehensive program is designed for professionals aiming to master the intricacies of optimizing software performance, ensuring applications run seamlessly under various conditions.
        </p>
        <br /><br />
        <h4>1. Everything in DevOps </h4>
        <br />
        <p>
          Delve into the essential principles Everything in DevOps, gaining insights into strategies for evaluating and enhancing the speed, responsiveness, and scalability of software applications.
        </p>
        <br />
        <h4>2. Tools and Technologies</h4>
        <br />
        <p>
          Acquire proficiency in leading Everything in DevOps tools and technologies, empowering you to conduct thorough assessments and identify areas for improvement in application performance.
        </p>
        <br />
        ...
        <div className="learn">
          ...
          <p><i className="far fa-check-circle"></i>Hands-on Experience with Leading Everything in DevOps Tools</p>
