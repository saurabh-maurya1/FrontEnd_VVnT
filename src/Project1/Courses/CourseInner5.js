  ...
  return (
    ...
    <section id="course-inner">
      <div className="overview">
        <img className="course-img" src="https://images.pexels.com/photos/7375/startup-photos.jpg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="" />
        <div className="course-head">
          <div className="c-name">
            <h2>Clean & Secure Code Development</h2>
            <div className="star">
        ...
        <br />
        <p>
          Elevate your skills to become a Clean & Secure Code Development expert with our specialized course: Clean & Secure Code Development In The Easiest Way". This comprehensive program is designed for professionals aiming to master the intricacies of optimizing software performance, ensuring applications run seamlessly under various conditions.
        </p>
        <br /><br />
        <h4>1.  Clean & Secure Code Development </h4>
        <br />
        <p>
          Delve into the essential principles Clean & Secure Code Development, gaining insights into strategies for evaluating and enhancing the speed, responsiveness, and scalability of software applications.
        </p>
        <br />
        <h4>2. Tools and Technologies</h4>
        <br />
        <p>
          Acquire proficiency in leading  Clean & Secure Code Development tools and technologies, empowering you to conduct thorough assessments and identify areas for improvement in application performance.
        </p>
        <br />
        ...
        <div className="learn">
          <p><i className="far fa-check-circle"></i> Clean & Secure Code Development Strategies and Best Practices</p>
          <p><i className="far fa-check-circle"></i>Hands-on Experience with Leading  Clean & Secure Code Development Tools</p>
