  ...
  return (
    ...
    <section id="course-inner">
      <div className="overview">
        <img className="course-img" src="https://media.istockphoto.com/id/1418476287/photo/businessman-analyzing-companys-financial-balance-sheet-working-with-digital-augmented-reality.webp?b=1&s=612x612&w=0&k=20&c=DfSCIoYtn5f7WcEwsZR-CtA9tY5dEA45rKs60yIKjJU=" alt="" />
        <div className="course-head">
          <div className="c-name">
            <h2>Privacy Engineering & Assurance </h2>
            <div className="star">
        ...
        <br />
        <p>
          Elevate your skills to become a proficient Privacy Privacy Engineering & Assurance  expert with our specialized course: "Privacy Privacy Engineering & Assurance  In The Easiest Way". This comprehensive program is designed for professionals aiming to master the intricacies of optimizing software performance, ensuring applications run seamlessly under various conditions.
        </p>
        <br /><br />
        <h4>1. Privacy Engineering & Assurance </h4>
        <br />
        <p>
          Delve into the essential principles of Privacy Privacy Engineering & Assurance , gaining insights into strategies for evaluating and enhancing the speed, responsiveness, and scalability of software applications.
        </p>
        <br />
        <h4>2. Tools and Technologies</h4>
        <br />
        <p>
          Acquire proficiency in leading Privacy Engineering & Assurance tools and technologies, empowering you to conduct thorough assessments and identify areas for improvement in application performance.
        </p>
        <br />
        ...
        <div className="learn">
          <p><i className="far fa-check-circle"></i>Privacy Engineering & Assurance Strategies and Best Practices</p>
          <p><i className="far fa-check-circle"></i>Hands-on Experience with Leading Privacy Engineering & Assurance Tools</p>
