...
import ig from '../courseimg/8.png'
        ...
        <div className="overview">
          ...
          <div className="course-head">
            <div className="c-name">
              <h2>Security Engineering & Assurance</h2>
              <div className="star">
          ...
          <br />
          <p>
            Elevate your skills to become a proficient Security Security Engineering & Assurance expert with our specialized course: Security Engineering & Assurance In The Easiest Way". This comprehensive program is designed for professionals aiming to master the intricacies of optimizing software performance, ensuring applications run seamlessly under various conditions.
          </p>
          <br /><br />
          <h4>1. Security Engineering & Assurance </h4>
          <br />
          <p>
            Delve into the essential principles of Security Security Engineering & Assurance, gaining insights into strategies for evaluating and enhancing the speed, responsiveness, and scalability of software applications.
          </p>
          <br />
          <h4>2. Tools and Technologies</h4>
          <br />
          <p>
            Acquire proficiency in leading Security Engineering & Assurance tools and technologies, empowering you to conduct thorough assessments and identify areas for improvement in application performance.
          </p>
          <br />
          ...
          <div className="learn">
            ...
            <p><i className="far fa-check-circle"></i>Hands-on Experience with Leading Security Engineering & Assurance Tools</p>
