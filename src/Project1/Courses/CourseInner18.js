  ...
  return (
    ...
    <section id="course-inner">
      <div className="overview">
        <img className="course-img" src="https://cdn.pixabay.com/photo/2020/02/19/07/48/web-4861605_1280.jpg" alt="" />
        <div className="course-head">
          <div className="c-name">
            <h2>Testing AI-based Systems & Automation</h2>
            <div className="star">
        ...
        <br />
        <p>
          Elevate your skills to become a proficient Testing AI-based Testing AI-based Systems & Automation expert with our specialized course: Testing AI-based Systems & Automation In The Easiest Way". This comprehensive program is designed for professionals aiming to master the intricacies of optimizing software performance, ensuring applications run seamlessly under various conditions.
        </p>
        <br /><br />
        <h4>1. Testing AI-based Systems & Automation Fundamentals</h4>
        <br />
        <p>
          Delve into the essential principles of Testing AI-based Testing AI-based Systems & Automation, gaining insights into strategies for evaluating and enhancing the speed, responsiveness, and scalability of software applications.
        </p>
        <br />
        <h4>2. Tools and Technologies</h4>
        <br />
        <p>
          Acquire proficiency in leading Testing AI-based Systems & Automation tools and technologies, empowering you to conduct thorough assessments and identify areas for improvement in application performance.
        </p>
        <br />
        ...
        <div className="learn">
          <p><i className="far fa-check-circle"></i>Performance Testing Strategies and Best Practices</p>
          <p><i className="far fa-check-circle"></i>Hands-on Experience with Leading Testing AI-based Systems & Automation Tools</p>
