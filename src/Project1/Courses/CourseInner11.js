  ...
  return (
    ...
    <section id="course-inner">
      <div className="overview">
        <img className="course-img" src="https://www.apexon.com/wp-content/themes/supernova/img/digital-assurance-tier1-img.jpg" alt="" />
        <div className="course-head">
          <div className="c-name">
            <h2>Microservices & API Testing</h2>
            <div className="star">
        ...
        <br />
        <p>
          Elevate your skills to become a proficient Microservices & API Testing  expert with our specialized course: "Microservices & API Testing  In The Easiest Way". This comprehensive program is designed for professionals aiming to master the intricacies of optimizing software performance, ensuring applications run seamlessly under various conditions.
        </p>
        <br /><br />
        <h4>1. Microservices & API Testing Fundamentals</h4>
        <br />
        <p>
          Delve into the essential principles of Microservices & API Testing , gaining insights into strategies for evaluating and enhancing the speed, responsiveness, and scalability of software applications.
        </p>
        <br />
        <h4>2. Tools and Technologies</h4>
        <br />
        <p>
          Acquire proficiency in leading Microservices & API Testing tools and technologies, empowering you to conduct thorough assessments and identify areas for improvement in application performance.
        </p>
        <br />
        ...
        <div className="learn">
          <p><i className="far fa-check-circle"></i>Microservices & API Testing Strategies and Best Practices</p>
          <p><i className="far fa-check-circle"></i>Hands-on Experience with Leading Microservices & API Testing Tools</p>
