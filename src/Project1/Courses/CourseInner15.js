  ...
  return (
    ...
    <section id="course-inner">
      <div className="overview">
        <img className="course-img" src={img16} alt="" />
        <div className="course-head">
          <div className="c-name">
            <h2>CyberLaws, Privacy Legislation & Compliance </h2>
            <div className="star">
        ...
        <br />
        <p>
          Elevate your skills to become a proficient CyberLaws, Privacy Legislation & Compliance  expert with our specialized course: "CyberLaws, Privacy Legislation & Compliance  In The Easiest Way". This comprehensive program is designed for professionals aiming to master the intricacies of optimizing software performance, ensuring applications run seamlessly under various conditions.
        </p>
        <br /><br />
        <h4>1. CyberLaws, Privacy Legislation & Compliance </h4>
        <br />
        <p>
          Delve into the essential principles of CyberLaws, Privacy Legislation & Compliance , gaining insights into strategies for evaluating and enhancing the speed, responsiveness, and scalability of software applications.
        </p>
        <br />
        <h4>2. Tools and Technologies</h4>
        <br />
        <p>
          Acquire proficiency in leading CyberLaws, Privacy Legislation & Compliance tools and technologies, empowering you to conduct thorough assessments and identify areas for improvement in application performance.
        </p>
        <br />
        ...
        <div className="learn">
          <p><i className="far fa-check-circle"></i>CyberLaws, Privacy Legislation & Compliance Strategies and Best Practices</p>
          <p><i className="far fa-check-circle"></i>Hands-on Experience with Leading CyberLaws, Privacy Legislation & Compliance Tools</p>
