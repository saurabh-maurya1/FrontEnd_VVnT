...
import ig from '../courseimg/4.jpg'
      ...
      <div className="overview">
        ...
        <div className="course-head">
          <div className="c-name">
            <h2>Automation Tools & Accelerators </h2>
            <div className="star">
        ...
        <br />
        <p>
          Elevate your skills to become a proficient Automation Tools & Accelerators  expert with our specialized course: "Automation Tools & Accelerators  In The Easiest Way". This comprehensive program is designed for professionals aiming to master the intricacies of optimizing software performance, ensuring applications run seamlessly under various conditions.
        </p>
        <br /><br />
        <h4>1. Automation Tools & Accelerators </h4>
        <br />
        <p>
          Delve into the essential principles of Automation Tools & Accelerators , gaining insights into strategies for evaluating and enhancing the speed, responsiveness, and scalability of software applications.
        </p>
        <br />
        <h4>2. Tools and Technologies</h4>
        <br />
        <p>
          Acquire proficiency in leading Automation Tools & Accelerators tools and technologies, empowering you to conduct thorough assessments and identify areas for improvement in application performance.
        </p>
        <br />
        ...
        <div className="learn">
          <p><i className="far fa-check-circle"></i>Automation Tools & Accelerators Strategies and Best Practices</p>
          <p><i className="far fa-check-circle"></i>Hands-on Experience with Leading Automation Tools & Accelerators Tools</p>
